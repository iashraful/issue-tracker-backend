...
class Issue(BaseEntity):
    ...
    author = models.ForeignKey('core.Profile', related_name='author', null=True, on_delete=models.SET_NULL)
    project = models.ForeignKey('pms.Project', null=True, on_delete=models.SET_NULL)
...
class IssueHistory(BaseEntity):
    issue = models.ForeignKey('pms.Issue', null=True, on_delete=models.SET_NULL)
    action_by = models.ForeignKey('core.Profile', related_name='action_by', null=True, on_delete=models.SET_NULL)
